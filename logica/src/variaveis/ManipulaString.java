...
public class ManipulaString {
	...
	System.out.println("Posicao do @: " +email.indexOf("@")); 
		//procura caracter e retorna a posição parte do 0
	...
	System.out.println("Pega do segundo ao quarto caracter: " +email.substring(1,4));
		//primeira coordenada começa do 0 e a segunda começa do 1
	
	System.out.println("A partir do segundo caracter: " +email.substring(1));
		//primeira coordenada começa do 0 
	...
	System.out.println("Servidor: " +email.substring(email.indexOf("@")+1));
		//retorna nome do server - pega tudo após o @
	...
	System.out.println("Comparação COM Case: " +email.equals("rafael@bol.com.br"));
		//verifica se eh exatamente igual e retorna true or false
	
	System.out.println("Comparação SEM Case: " +email.equalsIgnoreCase("rafael@bol.com.br"));
