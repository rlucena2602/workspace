...
public class Variavel {
	...
	// Variavel (primeira letra maiuscula) eh um espaço temporario na memoria RAM
	...
	/* 
	 * Tipos de dados:
	 * A) Numerico (int inteiro / double divisivel usa ,): o dado q sera utilizado em operação matematica
	 * 				e/ou for um dado critico p/ consulta
	 * 				 (Ex: CEP nos correrios)
	 * 
	 * B) Alfanumerico (String): naum eh utilizado em operações matematicas
	 * 	
	 */
	...
	idade = Integer.parseInt(JOptionPane.showInputDialog("Digite sua idade")); //parse faz uma substituição pois essa var eh numero e o show mostra apenas String
