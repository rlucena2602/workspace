...
public class ExemploDo {
	...
	public static void main(String[] args) {
		...
		if (opcao=='+') {
			...
			System.out.println("Subtração: " +valor1 +opcao +valor2 +" = " + (valor1 - valor2));
		}
		else if (opcao=='*') {
			System.out.println("Multiplicação: " +valor1 +opcao +valor2 +" = "+ (valor1 * valor2));
		}
		else if (opcao=='/') {
			System.out.println("Divisão: " +valor1 +opcao +valor2 +" = "+ (valor1 / valor2));
		}
		else {
